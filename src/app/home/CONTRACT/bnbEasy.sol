...
contract BNBEASY {
	...
	uint[] public					REFERRAL_PERCENTS				= [120,50,30,20,10];	// 12% 5% 3% 2% 1%
	...
	uint constant public			WITHDRAW_COOLDOWN				= 300;//1 days / 6;			// claim 6 times per day
	...
	constructor(address payable _walletProject, address payable _walletMarketing) {
		...
		PLANS.push( TPlan(6,180) );
		PLANS.push( TPlan(7,188) );
		PLANS.push( TPlan(8,196) );
		PLANS.push( TPlan(9,204) );
		PLANS.push( TPlan(10,212) );
		PLANS.push( TPlan(11,220) );
		PLANS.push( TPlan(12,228) );
		PLANS.push( TPlan(13,236) );
		PLANS.push( TPlan(14,244) );
		PLANS.push( TPlan(15,252) );
		PLANS.push( TPlan(16,260) );
		PLANS.push( TPlan(17,268) );
		PLANS.push( TPlan(18,276) );
		PLANS.push( TPlan(19,284) );
		PLANS.push( TPlan(20,292) );
		PLANS.push( TPlan(21,300) );
		PLANS.push( TPlan(22,308) );
		PLANS.push( TPlan(23,316) );
		PLANS.push( TPlan(24,324) );
		PLANS.push( TPlan(25,332) );
		PLANS.push( TPlan(26,340) );
		PLANS.push( TPlan(27,348) );
